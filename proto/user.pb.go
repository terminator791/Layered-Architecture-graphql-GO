...
const file_proto_user_proto_rawDesc = "" +
	...
	"\n" +
	"CreateUser\x12\x17.user.CreateUserRequest\x1a\x18.user.CreateUserResponseBHZFgithub.com/terminator791/Layered-Architecture-graphql-GO/pkg/grpc/userb\x06proto3"
